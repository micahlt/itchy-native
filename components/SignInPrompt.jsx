...
export default function SignInPrompt() {
    ...
    return <View style={{ backgroundColor: colors.accent, padding: 10, borderRadius: 10, marginHorizontal: 20, marginTop: 10 }}>
        ...
        <Text style={{ fontSize: 14, color: "white", marginBottom: 10 }}>Sign in to access features like messages, your What's Happening feed, commenting, loving and favoriting projects, controller customizations, and more!</Text>
