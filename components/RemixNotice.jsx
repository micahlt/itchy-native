...
export default function RemixNotice({ originalProjectID }) {
    ...
    return <Card style={{ marginHorizontal: 20, marginBottom: 10, backgroundColor: isDark ? "#04361b" : "#cfeedd", alignItems: "center", borderRadius: dimensions.mediumRadius }} pressableStyle={{ padding: 8, flexDirection: "row" }} onPress={() => router.push(`/projects/${originalProjectID}`)}>
        ...
        <View style={{ marginLeft: 14, flex: 1 }}>
            <ItchyText style={{ fontSize: 14, color: isDark ? "#6affad" : "#043319", fontWeight: "bold", marginBottom: 8, marginTop: 5 }}>This project is a remix of</ItchyText>
