...
export default function Joystick({
  ...
  const handleStyle = useAnimatedStyle(() => ({
    transform: [{ translateX: handleX.value }, { translateY: handleY.value }],
  }));
      ...
      <View
        style={{
          ...
          boxShadow: isFullscreen
            ? "none"
            : "0px 4px 10px 0px #0000001A inset, 0px 4px 5px 0px #FFFFFF1A",
          ...
          style={[
            {
              ...
              justifyContent: "center",
              alignItems: "center",
              outlineColor: isFullscreen
                ? "transparent"
                : "rgba(255, 255, 255, 0.15)",
              outlineWidth: isFullscreen ? 0 : 2,
              boxShadow: isFullscreen
                ? "none"
                : "box-shadow: 0px 8px 6px 0px rgba(255, 255, 255, 0.2) inset, 0px 4px 5px 0px rgba(255, 255, 255, 0.5) inset, 0px 4px 14px 5px rgba(0, 0, 0, 0.4)",
            },
            handleStyle,
          ]}
        ></Animated.View>
