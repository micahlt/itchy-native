...
export default function MultiPlayConfigSheet({
  ...
  return (
    ...
    >
      ...
      >
        Play local-multiplayer games online with WebRTC. Configure your
        multiplayer settings below to get started. We're assuming you already
        have your controller mappings set up for this project.
      </ItchyText>
      ...
      {isUserUnder13() && (
        ...
        >
          ...
          >
            ...
            />
            <ItchyText
              style={{ color: colors.accent, fontSize: 16, fontWeight: "bold" }}
            >
              Age Restriction
            </ItchyText>
          </View>
      ...
      <View style={{ alignItems: "center", marginBottom: 20 }}>
        ...
        >
          ...
          />
          <ItchyText
            style={{ color: statusInfo.color, fontSize: 14, fontWeight: "500" }}
          >
            {statusInfo.text}
          </ItchyText>
        </View>
        ...
        {connectionStatus === "failed" && (
          ...
          >
            Connection failed. It's likely that your network or the person
            connecting does not support WebRTC connections. See the{" "}
            <ItchyText
