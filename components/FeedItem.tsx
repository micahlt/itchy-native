...
interface FeedItemProps {
  item: UserActivity;
  textColor?: string;
  type?: "whatshappening" | "useractivity";
  ...
  return (
    <View style={{ borderRadius: 10, overflow: "hidden" }}>
      ...
      >
        ...
        >
          <AvatarWithIcon
            src={`https://uploads.scratch.mit.edu/get_image/user/${
          ...
          <View style={{ width: "85%" }}>
            ...
            <ItchyText
              style={{ fontWeight: "normal", color: textColor, fontSize: 10 }}
            >
              {type === "useractivity"
