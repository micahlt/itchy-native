        ...
        <>
            <ScrollView style={{ flex: 1 }} contentContainerStyle={{ flexGrow: 1, paddingBottom: insets.bottom + 20, paddingTop: insets.top }}>
                ...
                <View style={{ flexDirection: "row", columnGap: 15, alignItems: "center", justifyContent: "space-between", marginTop: 10, flex: 1 }}>
                    ...
                    />
                    <Chip.Icon icon={status == "Connected" ? "radio" : "warning"} text={status} mode="filled" style={{ marginRight: 15 }} color={status == "Connected" ? "#1fa81f" : undefined} />
                </View>
                ...
                {!!remoteStream ? (
                    <View style={{ width: width - 30, aspectRatio: 480 / 360, borderWidth: 2, borderRadius: 10, overflow: "hidden", marginHorizontal: 15, marginTop: 10, borderColor: colors.outline, borderWidth: dimensions.outlineWidth }}>
                        <RTCView
                        ...
                        />
                    </View>) : loading && <View style={{ width: width - 30, aspectRatio: 480 / 360, borderWidth: 2, borderRadius: 10, overflow: "hidden", marginHorizontal: 15, marginTop: 10, borderColor: colors.outline, borderWidth: dimensions.outlineWidth }}>
                ...
                <FastSquircleView cornerSmoothing={0.6} style={{
                    ...
                    <Controls onControlPress={sendKeyEvent} projectId={projectMetadata?.id} showConfiguration={true} />
                    {projectMetadata && (
                        <Card style={{ paddingHorizontal: 15, paddingVertical: 10, marginTop: 15, borderRadius: dimensions.mediumRadius }}>
