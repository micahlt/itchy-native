    ...
    return (
        <View style={{ backgroundColor: colors.background }}>
            ...
            <Card style={{ padding: 20, paddingBottom: 35, margin: 20 }}>
                ...
                <ItchyText style={{ color: colors.text, textAlign: "center", opacity: 0.5, fontSize: 12, paddingHorizontal: 10, marginVertical: 5 }}>Your username and password will be sent directly to Scratch's servers and not shared with any third parties.</ItchyText>
            </Card>
            <TexturedButton icon="key" iconSide="left" style={{ marginTop: -45, margin: "auto", paddingHorizontal: 10, backgroundColor: colors.accent, outlineColor: colors.accentOverlay, borderTopColor: "rgba(255,255,255,0.2)" }} textStyle={{ color: "white" }} size={13} onPress={logIn}>Log In</TexturedButton>
            <Card onPress={() => linkWithFallback("https://itchy.micahlindley.com/privacy")} pressableStyle={{ padding: 20 }} style={{ margin: 20, marginTop: 10 }}>
